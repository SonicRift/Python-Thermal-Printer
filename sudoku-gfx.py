...
def checkpuzzle(puzzle, board=None):
    ...
    if answer is None:
        return -1
    if board is not None and not boardmatches(board, answer):
        return -1
            ...
            for x in xrange(9):
                ...
                for n in numbers:
                    ...
                    if len(spots) == 0:
                        ...
                        guess, count = pickbetter(
                            guess, count, [(pos, n) for pos in spots]
                        )
        if stuck:
...
def posfor(x, y, axis=0):
    if axis == 0:
        ...
        return (0, 3, 6, 27, 30, 33, 54, 57, 60)[x] + (0, 1, 2, 9, 10, 11, 18, 19, 20)[
            y
        ]
